...
//
//
//	if (!m_bWeaponIsLowered && (pOwner->m_nButtons & IN_FORWARD) && (pOwner->m_nButtons & IN_SPEED) )
//	{
...
//
//
//	if (!m_bWeaponIsLowered && speed >= 100 )//(player->m_nButtons & IN_FORWARD)
//	{
...
//	}
//#endif
//	else if (m_bWeaponIsLowered && !(pOwner->m_nButtons & IN_SPEED) && !(pOwner->m_nButtons & IN_FORWARD) )
//	{
...
void CBaseCombatWeapon::ItemPostFrame( void )
{
	...
	// TUX: Make sure to call Sprint animations
